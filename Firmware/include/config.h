...
#define MOTOR1_PWM_PIN 18  // Pin GPIO18 para motor 1
#define MOTOR2_PWM_PIN 19  // Pin GPIO19 para motor 2

// Configuración PWM
#define PWM_FREQUENCY 5000      // Frecuencia PWM en Hz
#define PWM_RESOLUTION 8        // Resolución de 8 bits (0-255)
#define MOTOR1_PWM_CHANNEL 0    // Canal PWM 0 para motor 1
#define MOTOR2_PWM_CHANNEL 1    // Canal PWM 1 para motor 2
